        ...
        <div class="absolute">
            ...
            <router-link to="/home/hot">
                <svg
                    ...
                    data-prefix="fab"
                    data-icon="hotjar"
                    class="svg-inline--fa fa-hotjar fa-w-14"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                    width="20px"
            ...
            <router-link to="/home/entertainment">
                <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
            ...
            <router-link to="/home/lost-and-found">
                <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
